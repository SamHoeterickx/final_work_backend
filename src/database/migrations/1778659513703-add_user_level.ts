...
export class AddUserLevel1778659513703 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_level_enum" AS ENUM('BEGINNER')`);
        await queryRunner.query(`ALTER TABLE "users" ADD "level" "public"."users_level_enum" NOT NULL DEFAULT 'BEGINNER'`);
    }
