...
export class LessonsChaptersProgress1778165482232 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "chapters" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "tags" text array NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_af9c9ecbe2e5d87eecc4f9128f1" PRIMARY KEY ("uuid"))`);
        await queryRunner.query(`CREATE TABLE "lessons" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "estimatedDuration" integer NOT NULL, "content" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "chapterUuid" uuid, CONSTRAINT "PK_67edbf998244ca30b18a280c9a9" PRIMARY KEY ("uuid"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_profiles" ADD CONSTRAINT "FK_b95d23376e021671f5806dd5f3a" FOREIGN KEY ("userUuid") REFERENCES "users"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
