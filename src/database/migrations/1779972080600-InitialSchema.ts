...
export class InitialSchema1779972080600 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "chapters" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" jsonb NOT NULL, "slug" character varying NOT NULL, "description" jsonb NOT NULL, "tags" text array NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_af9c9ecbe2e5d87eecc4f9128f1" PRIMARY KEY ("uuid"))`,
        );
        await queryRunner.query(
